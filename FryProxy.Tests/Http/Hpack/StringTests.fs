...
[<Category("Raw")>]
[<TestCase(8u, "6e6f 2d63 6163 6865", ExpectedResult = "no-cache")>]
[<TestCase(10u, "6375 7374 6f6d 2d6b 6579", ExpectedResult = "custom-key")>]
[<TestCase(12u, "6375 7374 6f6d 2d76 616c 7565", ExpectedResult = "custom-value")>]
[<TestCase(15u, "7777 772e 6578 616d 706c 652e 636f 6d", ExpectedResult = "www.example.com")>]
let testDecodeRaw (len: uint32, hex: string) =
    Hex.decodeArr hex
...
[<Category("Huffman")>]
[<TestCase(6u, "a8eb 1064 9cbf", ExpectedResult = "no-cache")>]
[<TestCase(8u, "25a8 49e9 5ba9 7d7f", ExpectedResult = "custom-key")>]
[<TestCase(9u, "25a8 49e9 5bb8 e8b4 bf", ExpectedResult = "custom-value")>]
[<TestCase(12u, "f1e3 c2e5 f23a 6ba0 ab90 f4ff", ExpectedResult = "www.example.com")>]
let testDecodeHuf (len: uint32, hex: string) =
    Hex.decodeArr hex
