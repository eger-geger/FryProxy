...
let frameParserSuccessCases =
    ...
    seq {
        ...
        succeed
            ...
            { Header = { Length = 5u; Type = FrameType.DATA; Flags = 0uy; StreamId = 5u }
              Body =
                Data
                    { PadLength = 0uy
                      Data = ReadOnlyMemory([| 0x48uy; 0x65uy; 0x6Cuy; 0x6Cuy; 0x6Fuy |]) } }
        ...
        succeed
            ...
            { Header =
                { Length = 3u
                  ...
                  StreamId = 7u }
              Body = Data { PadLength = 0uy; Data = ReadOnlyMemory([| 0xAAuy; 0xBBuy; 0xCCuy |]) } }
    }
